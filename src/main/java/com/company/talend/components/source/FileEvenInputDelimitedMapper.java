...
public class FileEvenInputDelimitedMapper implements Serializable {
    ...
    public FileEvenInputDelimitedMapper(@Option("configuration") final FileEvenInputDelimitedMapperConfiguration configuration,
    ...
    @Split
    public List<FileEvenInputDelimitedMapper> split(@PartitionSize final long bundles) {
        ...
        // In this case bundles = 100 and we must try to return 10 FileEvenInputDelimitedMapper with 1/10 of the overall work each.
        //
    ...
    @Emitter
    public FileEvenInputDelimitedSource createWorker() {
        // here we create an actual worker,
        // you are free to rework the configuration etc but our default generated implementation
        // propagates the partition mapper entries.
        return new FileEvenInputDelimitedSource(configuration, service, recordBuilderFactory);
    }
}